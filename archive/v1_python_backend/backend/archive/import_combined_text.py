"""
LEGACY: SQLite-based importer archival script

This file is an archive of a legacy importer that stored chunks/summaries in
SQLite (using `aiosqlite`). It is retained for migration and historical
reference only. For modern ingestion, prefer the Neo4j importers.
"""

Kinect. Oliver, shut the **** **** He said. """
