...
echo ❌ No compatible Chromium browser found (Edge, Chrome, Brave).
echo Please edit this script to set your custom browser path.
pause
exit /b

:launch
echo 🚀 Launching with VULKAN backend...
echo Path: "%BROWSER%"
echo Data: "%USER_DATA%"
echo.
"%BROWSER%" %FLAGS% %URL%
