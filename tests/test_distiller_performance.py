...
async def test_large_text_performance():
    ...
    print(
        f"Performance improvement: {first_execution_time / second_execution_time:.2f}x faster"
    )
    print()
    ...
    print(
        ...
        result1.entities == result2.entities
        and result1.relationships == result2.relationships
        and result1.key_points == result2.key_points,
    )
