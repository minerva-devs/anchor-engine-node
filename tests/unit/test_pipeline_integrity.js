...
`.trim();
        ...
        await ingestService.ingestResult(atomized.compound, atomized.molecules, atomized.atoms, ['test_bucket']);
        ...
        if (compoundCheck.rows.length === 0)
            throw new Error('❌ Compound record not found.');
...
//# sourceMappingURL=test_pipeline_integrity.js.map