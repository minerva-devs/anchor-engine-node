...
class TestInjectorAgentNewIntegration:
    """Test suite for new InjectorAgent integration tests"""
    ...
    def test_injection_with_no_context_available(self):
        ...
        payload = {
            "message": "inject context about the capital of Mars",
            "context": {}
        }
