...
import { detectIntent, assembleAndSerialize, } from '../../services/search/graph-context-serializer.js';
import { buildSovereignPrompt, } from '../../services/search/sovereign-system-prompt.js';
/**
 ...
 */
export function composeRollingContext(query, results, tokenBudget = 4096) {
    // Constants
 ...
 */
export function composeGraphContext(query, anchors, walkerResults, user, tokenBudget = 4096) {
