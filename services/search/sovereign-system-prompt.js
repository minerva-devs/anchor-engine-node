 ...
 */
export function generateSystemPrompt(user, intent) {
 ...
 */
export function composeFullPrompt(systemPrompt, contextGraph, userQuery) {
 ...
 */
export function buildSovereignPrompt(user, intent, serializedGraph, query) {
