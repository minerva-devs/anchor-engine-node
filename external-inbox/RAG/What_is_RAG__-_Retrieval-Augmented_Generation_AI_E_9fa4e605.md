# What is RAG? - Retrieval-Augmented Generation AI Explained - AWSxfacebooklinkedininstagramtwitchyoutubepodcastsemail
> **Source**: https://aws.amazon.com/what-is/retrieval-augmented-generation/
> **Date**: 2026-01-23T17:14:26.072Z
> **Description**: What is Retrieval-Augmented Generation (RAG), how and why businesses use RAG AI, and how to use RAG with AWS.
...
*   [What is Retrieval-Augmented Generation?](#what-is-retrieval-augmented-generation--1xobboj)
*   [Why is Retrieval-Augmented Generation important?](#why-is-retrieval-augmented-generation-important--1xobboj)
*   [What are the benefits of Retrieval-Augmented Generation?](#what-are-the-benefits-of-retrieval-augmented-generation--1xobboj)
*   [How does Retrieval-Augmented Generation work?](#how-does-retrieval-augmented-generation-work--1xobboj)
*   [What is the difference between Retrieval-Augmented Generation and semantic search?](#what-is-the-difference-between-retrieval-augmented-generation-and-semantic-search--1xobboj)
*   [How can AWS support your Retrieval-Augmented Generation requirements?](#how-can-aws-support-your-retrieval-augmented-generation-requirements--1xobboj)
