...
def truncate_text_to_tokens(text: str, max_tokens: int, model_name: str = "gpt-4") -> str:
    """
...
def split_text_by_tokens(text: str, tokens_per_chunk: int, model_name: str = "gpt-4") -> List[str]:
    """
