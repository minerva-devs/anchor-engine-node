...
This script tests the enhanced context flow implementation to verify that:
1. The Orchestrator properly coordinates with the Archivist and QLearning Agent
2. The Archivist coordinates with the QLearning Agent to retrieve enhanced context
3. Context is properly appended to the Redis cache before passing to other agents
4. Agents read the full context cache before responding to users
5. The QLearning Agent processes up to 1M tokens of context as requested
"""
...
Read the context carefully before formulating your answer."""
    ...
    print("   - Ensuring agents read full context before responding")
